...
def train_model_naive_bayes(df, target_column, label_mappings, label_encoders):
    ...
    # Save to a file
    joblib.dump(model_data, '../trained_naive_bayes_model.pkl')
...
def main():
    ...
    model, X_train_scaled, X_test_scaled, y_train, y_test = train_model_naive_bayes(df, target_column, label_mappings, label_encoders)
