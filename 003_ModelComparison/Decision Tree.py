...
"""
The following code trains a Decision Tree Model by applying the strategy mentioned in the report
"""
...
def train_model_decision_tree(df, target_column, label_mappings, label_encoders):
    """
    ...
    # Uncomment the following lines to enable feature selection
    ...
    # Save to a file
    joblib.dump(model_data, '../005_UserUI/trained_decision_tree_model.pkl')
...
def main():
    ...
    model, x_train, x_test, y_train, y_test = train_model_decision_tree(df, target_column, label_mappings, label_encoders)
    ...
    construct_confussion_matrix(model, x_test, y_test, label_mappings, model_name="Decision Tree")
