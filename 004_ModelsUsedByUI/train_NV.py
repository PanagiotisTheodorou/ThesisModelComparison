...
def train_naive_bayes(df, target_column, label_mappings):
    """
    Function to train a Naive Bayes model with error handling and debugging.
    """
    ...
    try:
        ...
        print("Step 5: Training the Naive Bayes model...")
        model = GaussianNB()
        ...
        # Step 8: Decode numeric labels back to original class labels
        print("Step 8: Decoding predictions...")
        ...
        print("Step 9: Generating classification report...")
